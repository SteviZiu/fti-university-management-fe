...
const authentication = (state, action) => {
    ...
    switch (action.type) {
        ...
        case EnumAuthActions.SET_USER_MODIFIED:
            console.log('[Reducer authentication] action: ' + action.type);
            return Object.assign({}, state, { userModified: action.dati });

        case EnumAuthActions.UPDATE_USER_MODIFIED:
            console.log('[Reducer authentication] action: ' + action.type);
            return update(state, { userModified: { $merge: action.dati } });
